...
function default_parser_item($add_item = array())
{
    ...
    $return = array(
        ...
        'copyright_setup'   => 'Copyright &copy; 2023 - ' . date('Y') . ' Kelompok 2 - <a href="">dokumenary.net</a>',
    ...
    if ($CI->uri->segment(1) != 'setup') {
        $return['copyright'] = 'Copyright &copy; 2023 - ' . ' ' . get_pengaturan('nama-sekolah', 'value').' by Kelompok 2 - <a href=""></a>';
